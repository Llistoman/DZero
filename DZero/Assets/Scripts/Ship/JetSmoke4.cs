...
public class JetSmoke4 : MonoBehaviour {

	public ParticleSystem jetSmoke1;
	public ParticleSystem jetSmoke2;
	public ParticleSystem jetSmoke3;
	public ParticleSystem jetSmoke4;
	...
	private void FixedUpdate()
	{
		...
		jetSmoke3.startSize = Mathf.Clamp (engineRevs, LowPitch, HighPitch);
		jetSmoke4.startSize = Mathf.Clamp (engineRevs, LowPitch, HighPitch);
	}
}
